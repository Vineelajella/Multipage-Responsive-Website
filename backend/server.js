...
const courseVideos = [
    { title: 'HTML Basics', url: 'https://www.youtube.com/embed/dD2EISBDjWM' },
    { title: 'CSS Fundamentals', url: 'https://www.youtube.com/embed/yfoY53QXEnI' },
    { title: 'JavaScript 101', url: 'https://www.youtube.com/embed/PkZNo7MFNFg' }
];
...
// ... (no changes in server.js until the following code)
...
app.get('/api/course-videos', async (req, res) => {
    try {
        const courseVideos = [
            ...
            { title:'App Development  ',url:'https://www.youtube.com/embed/CzRQ9mnmh44?si=137t0Jb4clT-lNY8',courseName:'App Development Course'},
